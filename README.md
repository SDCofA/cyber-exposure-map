...
- **Source:** Google News RSS; query: `(cyberattack OR ransomware OR vulnerability OR CVE)`. Google News chooses the matching sources; this is a convenience sample, not a complete census.
...
- **Limit:** News coverage does not identify vulnerable hosts, verified CVE exploitation, or infrastructure exposure. Search ranking, publisher coverage, duplication and publication delays bias the sample. Follow linked primary sources before drawing conclusions.
